...
#адрес контракта
contract = '0x4FA7163E153419E0E1064e418dd7A99314Ed27b6'

#ставим в переменную контракт и аби
contract_instance = web3.eth.contract(address = contract, abi = abi )

#запрашиваем саплай
hotcross_supply = contract_instance.functions.totalSupply().call()
print(web3.fromWei(hotcross_supply, 'ether'))

#запрашиваем символ токена
hotcross_symbol = contract_instance.functions.symbol().call()
print(hotcross_symbol)

#запрашиваем баланс кошелька
balance = contract_instance.functions.balanceOf('адрес кошелька').call()
